...
- [Instructions for Mac OS X](http://datascibc/datathon-2016/02a-install-mac.md)
- [Instructions for Windows](http://datascibc/datathon-2016/02b-install-windows.md)
- [Instructions for Linux (Ubuntu)](http://datascibc/datathon-2016/02c-install-ubuntu.md)
